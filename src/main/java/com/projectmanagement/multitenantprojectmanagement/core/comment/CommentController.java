...
public class CommentController {
    ...
    public ResponseEntity<PaginatedResponseDto<CommentResponse>> getCommentsByIssueId(@PathVariable UUID id, Pageable pageable) {
    ...
    public ResponseEntity<PaginatedResponseDto<CommentResponse>> getCommentReplies(@PathVariable UUID id, Pageable pageable) {
    ...
    public ResponseEntity<CommentResponse> createCommentReply(@RequestBody CreateCommentReplyRequest createCommentReplyRequest) {
    ...
    public ResponseEntity<CommentResponse> deleteCommentById(@PathVariable UUID id) {

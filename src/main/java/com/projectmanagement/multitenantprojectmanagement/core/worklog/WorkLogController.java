...
public class WorkLogController {
    ...
    public ResponseEntity<WorklogResponse> getWorklogById(@PathVariable UUID id) {
    ...
    public ResponseEntity<WorklogResponse> createWorklog(@RequestBody CreateWorklogRequest createWorklogRequest) {
    ...
    public ResponseEntity<WorklogResponse> updateWorklog(@RequestBody UpdateWorklogRequest updateWorklogRequest) {
    ...
    public ResponseEntity<WorklogResponse> deleteWorklog(@PathVariable UUID id) {
